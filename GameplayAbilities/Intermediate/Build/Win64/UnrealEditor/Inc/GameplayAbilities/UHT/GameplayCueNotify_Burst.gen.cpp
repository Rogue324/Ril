...
static const FName NAME_UGameplayCueNotify_Burst_OnBurst = FName(TEXT("OnBurst"));
void UGameplayCueNotify_Burst::OnBurst(AActor* Target, FGameplayCueParameters const& Parameters, FGameplayCueNotify_SpawnResult const& SpawnResults) const
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UGameplayCueNotify_Burst_OnBurst);
		const_cast<UGameplayCueNotify_Burst*>(this)->ProcessEvent(Func,&Parms);
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Burst_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Burst_h_1455817830(TEXT("/Script/GameplayAbilities"),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Burst_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Burst_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
