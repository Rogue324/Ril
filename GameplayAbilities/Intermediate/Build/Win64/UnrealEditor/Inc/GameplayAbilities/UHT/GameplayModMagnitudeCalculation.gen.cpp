...
static const FName NAME_UGameplayModMagnitudeCalculation_CalculateBaseMagnitude = FName(TEXT("CalculateBaseMagnitude"));
float UGameplayModMagnitudeCalculation::CalculateBaseMagnitude(FGameplayEffectSpec const& Spec) const
{
	UFunction* Func = FindFunctionChecked(NAME_UGameplayModMagnitudeCalculation_CalculateBaseMagnitude);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		GameplayModMagnitudeCalculation_eventCalculateBaseMagnitude_Parms Parms;
		Parms.Spec=Spec;
		const_cast<UGameplayModMagnitudeCalculation*>(this)->ProcessEvent(Func,&Parms);
		return Parms.ReturnValue;
	}
	else
	{
		return const_cast<UGameplayModMagnitudeCalculation*>(this)->CalculateBaseMagnitude_Implementation(Spec);
	}
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayModMagnitudeCalculation_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayModMagnitudeCalculation_h_3065534208(TEXT("/Script/GameplayAbilities"),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayModMagnitudeCalculation_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayModMagnitudeCalculation_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
