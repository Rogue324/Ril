...
static const FName NAME_AGameplayCueNotify_Looping_OnApplication = FName(TEXT("OnApplication"));
void AGameplayCueNotify_Looping::OnApplication(AActor* Target, FGameplayCueParameters const& Parameters, FGameplayCueNotify_SpawnResult const& SpawnResults)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AGameplayCueNotify_Looping_OnApplication);
...
static const FName NAME_AGameplayCueNotify_Looping_OnLoopingStart = FName(TEXT("OnLoopingStart"));
void AGameplayCueNotify_Looping::OnLoopingStart(AActor* Target, FGameplayCueParameters const& Parameters, FGameplayCueNotify_SpawnResult const& SpawnResults)
{
	...
	Parms.Parameters=Parameters;
	Parms.SpawnResults=SpawnResults;
	UFunction* Func = FindFunctionChecked(NAME_AGameplayCueNotify_Looping_OnLoopingStart);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_AGameplayCueNotify_Looping_OnRecurring = FName(TEXT("OnRecurring"));
void AGameplayCueNotify_Looping::OnRecurring(AActor* Target, FGameplayCueParameters const& Parameters, FGameplayCueNotify_SpawnResult const& SpawnResults)
{
	...
	Parms.Parameters=Parameters;
	Parms.SpawnResults=SpawnResults;
	UFunction* Func = FindFunctionChecked(NAME_AGameplayCueNotify_Looping_OnRecurring);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_AGameplayCueNotify_Looping_OnRemoval = FName(TEXT("OnRemoval"));
void AGameplayCueNotify_Looping::OnRemoval(AActor* Target, FGameplayCueParameters const& Parameters, FGameplayCueNotify_SpawnResult const& SpawnResults)
{
	...
	Parms.Parameters=Parameters;
	Parms.SpawnResults=SpawnResults;
	UFunction* Func = FindFunctionChecked(NAME_AGameplayCueNotify_Looping_OnRemoval);
	ProcessEvent(Func,&Parms);
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Looping_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGameplayCueNotify_Looping, AGameplayCueNotify_Looping::StaticClass, TEXT("AGameplayCueNotify_Looping"), &Z_Registration_Info_UClass_AGameplayCueNotify_Looping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameplayCueNotify_Looping), 1242183229U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Looping_h_1377385161(TEXT("/Script/GameplayAbilities"),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Looping_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Looping_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
