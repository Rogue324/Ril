...
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "AddBase.Comment", "/** Adds to the Base value. This happens first, before all other mods are considered. */" },
		{ "AddBase.DisplayName", "Add (Base)" },
		{ "AddBase.Name", "EGameplayModOp::AddBase" },
		{ "AddBase.ToolTip", "Adds to the Base value. This happens first, before all other mods are considered." },
		{ "AddFinal.Comment", "/** Add this value to the final computed result. */" },
		{ "AddFinal.DisplayName", "Add (Final)" },
		{ "AddFinal.Name", "EGameplayModOp::AddFinal" },
		{ "AddFinal.ToolTip", "Add this value to the final computed result." },
		{ "Additive.Comment", "// Backwards compatible names\n" },
		{ "Additive.Hidden", "" },
		{ "Additive.Name", "EGameplayModOp::Additive" },
		{ "Additive.ToolTip", "Backwards compatible names" },
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**\n\x09 * Defines the ways that mods will modify attributes. Values of the same type are aggregated, and then applied in the following equation:\n\x09 * ((BaseValue + AddBase) * MultiplyAdditive / DivideAdditive * MultiplyCompound) + AddFinal\n\x09 */" },
#endif
		{ "DivideAdditive.Comment", "/** Divisors are added together, then divided against the prev result. E.g. 1/2 + 1/2 = 1/3 in values is 2 + 2 = 3. */" },
		{ "DivideAdditive.DisplayName", "Divide (Additive)" },
		{ "DivideAdditive.Name", "EGameplayModOp::DivideAdditive" },
		{ "DivideAdditive.ToolTip", "Divisors are added together, then divided against the prev result. E.g. 1/2 + 1/2 = 1/3 in values is 2 + 2 = 3." },
		{ "Division.Comment", "// Backwards compat name\n" },
		{ "Division.Hidden", "" },
		{ "Division.Name", "EGameplayModOp::Division" },
		{ "Division.ToolTip", "Backwards compat name" },
		{ "Max.Comment", "/** This must always be the last value (used in iteration code). */" },
		{ "Max.DisplayName", "Invalid" },
		{ "Max.Hidden", "" },
		{ "Max.Name", "EGameplayModOp::Max" },
		{ "Max.ToolTip", "This must always be the last value (used in iteration code)." },
		{ "ModuleRelativePath", "Public/GameplayEffectTypes.h" },
		{ "Multiplicitive.Comment", "// Backwards compat name\n" },
		{ "Multiplicitive.Hidden", "" },
		{ "Multiplicitive.Name", "EGameplayModOp::Multiplicitive" },
		{ "Multiplicitive.ToolTip", "Backwards compat name" },
		{ "MultiplyAdditive.Comment", "/** Multipliers are added together first, then multiplied against prev result. E.g. 50% + 50% = 100% in values is 1.5 + 1.5 = 2.0. */" },
		{ "MultiplyAdditive.DisplayName", "Multiply (Additive)" },
		{ "MultiplyAdditive.Name", "EGameplayModOp::MultiplyAdditive" },
		{ "MultiplyAdditive.ToolTip", "Multipliers are added together first, then multiplied against prev result. E.g. 50% + 50% = 100% in values is 1.5 + 1.5 = 2.0." },
		{ "MultiplyCompound.Comment", "/** Multiply the prev result by this value. E.g. two values of 1.5 compounded: 1.5 * 1.5 = 2.25. */" },
		{ "MultiplyCompound.DisplayName", "Multiply (Compound)" },
		{ "MultiplyCompound.Name", "EGameplayModOp::MultiplyCompound" },
		{ "MultiplyCompound.ToolTip", "Multiply the prev result by this value. E.g. two values of 1.5 compounded: 1.5 * 1.5 = 2.25." },
		{ "Override.Comment", "/** Override the value, regardless of what the computation provides. */" },
		{ "Override.DisplayName", "Override" },
		{ "Override.Name", "EGameplayModOp::Override" },
		{ "Override.ToolTip", "Override the value, regardless of what the computation provides." },
		{ "OverrideBaseValue.Comment", "/** Only Override Base Value In Calculated*/" },
		{ "OverrideBaseValue.DisplayName", "OverrideBaseValue" },
		{ "OverrideBaseValue.Name", "EGameplayModOp::OverrideBaseValue" },
		{ "OverrideBaseValue.ToolTip", "Only Override Base Value In Calculated" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Defines the ways that mods will modify attributes. Values of the same type are aggregated, and then applied in the following equation:\n((BaseValue + AddBase) * MultiplyAdditive / DivideAdditive * MultiplyCompound) + AddFinal" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EGameplayModOp::AddBase", (int64)EGameplayModOp::AddBase },
		{ "EGameplayModOp::MultiplyAdditive", (int64)EGameplayModOp::MultiplyAdditive },
		{ "EGameplayModOp::DivideAdditive", (int64)EGameplayModOp::DivideAdditive },
		{ "EGameplayModOp::MultiplyCompound", (int64)EGameplayModOp::MultiplyCompound },
		{ "EGameplayModOp::AddFinal", (int64)EGameplayModOp::AddFinal },
		{ "EGameplayModOp::OverrideBaseValue", (int64)EGameplayModOp::OverrideBaseValue },
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ EGameplayModOp_StaticEnum, TEXT("EGameplayModOp"), &Z_Registration_Info_UEnum_EGameplayModOp, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1384064135U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectTypes_h_827878547(TEXT("/Script/GameplayAbilities"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectTypes_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectTypes_h_Statics::EnumInfo));
// End Registration
