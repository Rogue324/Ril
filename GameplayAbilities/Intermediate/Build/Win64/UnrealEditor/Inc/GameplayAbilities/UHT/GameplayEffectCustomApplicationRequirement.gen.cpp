...
static const FName NAME_UGameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect = FName(TEXT("CanApplyGameplayEffect"));
...
{
	UFunction* Func = FindFunctionChecked(NAME_UGameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		...
		Parms.Spec=Spec;
		Parms.ASC=ASC;
		const_cast<UGameplayEffectCustomApplicationRequirement*>(this)->ProcessEvent(Func,&Parms);
		return !!Parms.ReturnValue;
	}
	else
	{
		return const_cast<UGameplayEffectCustomApplicationRequirement*>(this)->CanApplyGameplayEffect_Implementation(GameplayEffect, Spec, ASC);
	}
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectCustomApplicationRequirement_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectCustomApplicationRequirement_h_3642523708(TEXT("/Script/GameplayAbilities"),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectCustomApplicationRequirement_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayEffectCustomApplicationRequirement_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
