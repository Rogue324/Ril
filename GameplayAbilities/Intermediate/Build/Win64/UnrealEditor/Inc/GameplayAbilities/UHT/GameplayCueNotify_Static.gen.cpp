...
static const FName NAME_UGameplayCueNotify_Static_K2_HandleGameplayCue = FName(TEXT("K2_HandleGameplayCue"));
void UGameplayCueNotify_Static::K2_HandleGameplayCue(AActor* MyTarget, EGameplayCueEvent::Type EventType, FGameplayCueParameters const& Parameters) const
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UGameplayCueNotify_Static_K2_HandleGameplayCue);
		const_cast<UGameplayCueNotify_Static*>(this)->ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UGameplayCueNotify_Static_OnActive = FName(TEXT("OnActive"));
bool UGameplayCueNotify_Static::OnActive(AActor* MyTarget, FGameplayCueParameters const& Parameters) const
{
	UFunction* Func = FindFunctionChecked(NAME_UGameplayCueNotify_Static_OnActive);
	...
	{
		return const_cast<UGameplayCueNotify_Static*>(this)->OnActive_Implementation(MyTarget, Parameters);
	}
}
...
static const FName NAME_UGameplayCueNotify_Static_OnExecute = FName(TEXT("OnExecute"));
bool UGameplayCueNotify_Static::OnExecute(AActor* MyTarget, FGameplayCueParameters const& Parameters) const
{
	UFunction* Func = FindFunctionChecked(NAME_UGameplayCueNotify_Static_OnExecute);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UGameplayCueNotify_Static*>(this)->OnExecute_Implementation(MyTarget, Parameters);
	}
}
...
static const FName NAME_UGameplayCueNotify_Static_OnRemove = FName(TEXT("OnRemove"));
bool UGameplayCueNotify_Static::OnRemove(AActor* MyTarget, FGameplayCueParameters const& Parameters) const
{
	UFunction* Func = FindFunctionChecked(NAME_UGameplayCueNotify_Static_OnRemove);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UGameplayCueNotify_Static*>(this)->OnRemove_Implementation(MyTarget, Parameters);
	}
}
...
static const FName NAME_UGameplayCueNotify_Static_WhileActive = FName(TEXT("WhileActive"));
bool UGameplayCueNotify_Static::WhileActive(AActor* MyTarget, FGameplayCueParameters const& Parameters) const
{
	UFunction* Func = FindFunctionChecked(NAME_UGameplayCueNotify_Static_WhileActive);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UGameplayCueNotify_Static*>(this)->WhileActive_Implementation(MyTarget, Parameters);
	}
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Static_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Static_h_623083342(TEXT("/Script/GameplayAbilities"),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Static_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_GameplayCueNotify_Static_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
