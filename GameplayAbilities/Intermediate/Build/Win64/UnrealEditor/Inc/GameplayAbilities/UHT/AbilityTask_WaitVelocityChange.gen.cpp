...
struct Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics
{
	...
	static const UECodeGen_Private::FWeakObjectPropertyParams NewProp_CachedMovementComponent;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::NewProp_CachedMovementComponent = { "CachedMovementComponent", nullptr, (EPropertyFlags)0x0024080000080008, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_WaitVelocityChange, CachedMovementComponent), Z_Construct_UClass_UMovementComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CachedMovementComponent_MetaData), NewProp_CachedMovementComponent_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitVelocityChange_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitVelocityChange, UAbilityTask_WaitVelocityChange::StaticClass, TEXT("UAbilityTask_WaitVelocityChange"), &Z_Registration_Info_UClass_UAbilityTask_WaitVelocityChange, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitVelocityChange), 858596256U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitVelocityChange_h_3567398349(TEXT("/Script/GameplayAbilities"),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitVelocityChange_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitVelocityChange_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
