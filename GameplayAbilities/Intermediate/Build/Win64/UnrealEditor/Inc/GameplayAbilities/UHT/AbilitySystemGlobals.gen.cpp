...
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Holds global data for the ability system. Configuration is done via the Developer Settings, Project -> Gameplay Abilities Settings  */" },
#endif
		{ "IncludePath", "AbilitySystemGlobals.h" },
		{ "ModuleRelativePath", "Public/AbilitySystemGlobals.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Holds global data for the ability system. Configuration is done via the Developer Settings, Project -> Gameplay Abilities Settings" },
#endif
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAbilitySystemGlobals_Statics::NewProp_GlobalAttributeSetDefaultsTableNames_Inner = { "GlobalAttributeSetDefaultsTableNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAbilitySystemGlobals_Statics::NewProp_GlobalAttributeSetDefaultsTableNames = { "GlobalAttributeSetDefaultsTableNames", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilitySystemGlobals, GlobalAttributeSetDefaultsTableNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GlobalAttributeSetDefaultsTableNames_MetaData), NewProp_GlobalAttributeSetDefaultsTableNames_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_AbilitySystemGlobals_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAbilitySystemGlobals, UAbilitySystemGlobals::StaticClass, TEXT("UAbilitySystemGlobals"), &Z_Registration_Info_UClass_UAbilitySystemGlobals, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilitySystemGlobals), 3319177559U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_AbilitySystemGlobals_h_179522990(TEXT("/Script/GameplayAbilities"),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_AbilitySystemGlobals_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_AbilitySystemGlobals_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_AbilitySystemGlobals_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PO_Plugins_GameplayAbilities_Source_GameplayAbilities_Public_AbilitySystemGlobals_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
